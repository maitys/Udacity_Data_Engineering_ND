...
def process_song_file(cur, filepath):
    ...
    to get the song and artist info and used to populate the songs and artists tables.
...
def process_data(cur, conn, filepath, func):
    """
    Description: This function takes in the connection credentials, filepath, and functions used to read and process the files to appropriate tables.

    Arguments:
      cur: the cursor object.
      conn: postgres connection  
      filepath: song data file path or log data file path.
      func:  process_song_file or process_log_file depending on which file needs to be processed
