...
class LoadFactOperator(BaseOperator):
    '''
    This Operator class loads data into a specified fact table in Redshift.
    ...
    Output: logs the result of the data load after the data is loaded into the fact tables
    '''
    ui_color = '#F98866'
    ...
    def execute(self, context):
        ...
        if self.mode == "delete-load":
            self.log.info(f"Deleting data from fact table {self.table}")
